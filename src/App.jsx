...
function App() {
  ...
  const cards = [
  { question: "Who is the father of Computer Science?", answer: "Alan Turing", difficulty: "easy" },
  { question: "Who was the first programmer?", answer: "Ada Lovelace", difficulty: "easy" },
